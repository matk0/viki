...
const sk = {
  ...
  'assistant.turn.title': 'Viki pripravuje zmeny',
  'assistant.turn.description': 'Kým čakáte, môžete sledovať, čo práve robím.',
  'assistant.turn.summary': 'Priebežné zhrnutie',
  'assistant.turn.created': 'Vytvorené drafty',
  'assistant.turn.redirecting': 'Hotovo. Otváram novú funkciu…',
  'assistant.turn.clarification': 'Potrebujem od vás doplnenie. Odpovedzte v asistentovi.',
  'assistant.turn.stopped': 'Príprava zmien bola zastavená.',
  'assistant.turn.failed': 'Zmeny sa nepodarilo pripraviť.',
  'assistant.turn.unavailable': 'Tento priebeh už nie je dostupný.',
  'assistant.turn.activity.understanding': 'Rozumiem zadaniu',
  'assistant.turn.activity.searching': 'Hľadám súvisiace informácie',
  'assistant.turn.activity.searched': 'Našiel som súvisiace stránky',
  'assistant.turn.activity.reading': 'Čítam existujúce stránky',
  'assistant.turn.activity.read': 'Mám potrebné podklady',
  'assistant.turn.activity.drafting': 'Vytváram drafty',
  'assistant.turn.activity.drafted': 'Drafty sú pripravené',
  'assistant.turn.activity.continuing': 'Pokračujem po doplnení',
  'assistant.turn.activity.working': 'Pracujem na zmenách',
...
const en: Record<TranslationKey, string> = {
  ...
  'new.eyebrow': 'New draft', 'new.createConcept': 'Create concept', 'new.createFeature': 'Create feature', 'new.createScenario': 'Create scenario', 'new.conceptKind': 'Concept kind', 'new.conceptKinds': 'Concept kinds', 'new.noun': 'Noun', 'new.verb': 'Verb', 'new.title': 'Title', 'new.initialScenario': 'First scenario', 'new.scenarioTitle': 'Scenario title', 'new.titlePlaceholder': 'For example Service availability', 'new.failed': 'The page could not be created.', 'new.creating': 'Creating…', 'new.submit': 'Create draft',
